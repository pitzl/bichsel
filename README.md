...
generated by Monte Carlo simulation of many particle tracks:
simdelta.cc (extracted from pixelav.c by M. Swartz, Johns Hopkins, 2006)  
It produces simdelta.root from eesig-e5000.dat

example plot: 5 GeV electrons passing 150 um Si

![energy loss](sumde.png "energy loss in 150 um Si")
